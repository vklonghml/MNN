...
void Arm82Binary(void *dstRaw, const void *src0Raw, const void *src1Raw, const int elementSize, const int needBroadcastIndex) {
    ...
    if (-1 == needBroadcastIndex) {
        for (int i = 0; i < sizeDivUnitU; ++i) {
            auto a0 = vld1q_f16(src0 + 0);
            auto b0 = vld1q_f16(src1 + 0);
            auto a1 = vld1q_f16(src0 + 8);
            auto b1 = vld1q_f16(src1 + 8);
            auto a2 = vld1q_f16(src0 + 16);
            auto b2 = vld1q_f16(src1 + 16);
            auto a3 = vld1q_f16(src0 + 24);
            auto b3 = vld1q_f16(src1 + 24);
            auto a4 = vld1q_f16(src0 + 32);
            auto b4 = vld1q_f16(src1 + 32);
            auto a5 = vld1q_f16(src0 + 40);
            auto b5 = vld1q_f16(src1 + 40);
            auto a6 = vld1q_f16(src0 + 48);
            auto b6 = vld1q_f16(src1 + 48);
            auto a7 = vld1q_f16(src0 + 56);
            auto b7 = vld1q_f16(src1 + 56);
            vst1q_f16(dst + 0, compute(a0, b0));
            vst1q_f16(dst + 8, compute(a1, b1));
            vst1q_f16(dst + 16, compute(a2, b2));
            vst1q_f16(dst + 24, compute(a3, b3));
            vst1q_f16(dst + 32, compute(a4, b4));
            vst1q_f16(dst + 40, compute(a5, b5));
            vst1q_f16(dst + 48, compute(a6, b6));
            vst1q_f16(dst + 56, compute(a7, b7));
        ...
        for (int i = 0; i < sizeDivUnitU; ++i) {
            ...
            auto b6 = vld1q_f16(src1 + 48);
            auto b7 = vld1q_f16(src1 + 56);
            vst1q_f16(dst + 0, compute(a, b0));
            vst1q_f16(dst + 8, compute(a, b1));
            vst1q_f16(dst + 16, compute(a, b2));
            vst1q_f16(dst + 24, compute(a, b3));
            vst1q_f16(dst + 32, compute(a, b4));
            vst1q_f16(dst + 40, compute(a, b5));
            vst1q_f16(dst + 48, compute(a, b6));
            vst1q_f16(dst + 56, compute(a, b7));
            src1 += ARMV82_CHANNEL_UNIT * unroll;
            dst += ARMV82_CHANNEL_UNIT * unroll;
        }
        int remainUnit = sizeDivUnitRemain;
        ...
        for (int i = 0; i < sizeDivUnitU; ++i) {
            ...
            auto a6 = vld1q_f16(src0 + 48);
            auto a7 = vld1q_f16(src0 + 56);
            vst1q_f16(dst + 0, compute(a0, b));
            vst1q_f16(dst + 8, compute(a1, b));
            vst1q_f16(dst + 16, compute(a2, b));
            vst1q_f16(dst + 24, compute(a3, b));
            vst1q_f16(dst + 32, compute(a4, b));
            vst1q_f16(dst + 40, compute(a5, b));
            vst1q_f16(dst + 48, compute(a6, b));
            vst1q_f16(dst + 56, compute(a7, b));
            src0 += ARMV82_CHANNEL_UNIT * unroll;
            dst += ARMV82_CHANNEL_UNIT * unroll;
        }
        int remainUnit = sizeDivUnitRemain;
